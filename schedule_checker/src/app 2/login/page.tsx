      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
          ...
          <div className="relative my-6">
            <span className="block text-center text-sm text-slate-400">또는</span>
          </div>
          <button
            type="button"
            onClick={handleGoogleSignIn}
            disabled={submitting}
            className="w-full py-2.5 border border-slate-200 rounded-lg font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-50 transition-colors flex items-center justify-center gap-2"
          >
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          <Link href="/" className="text-indigo-600 hover:underline">개발 현황 보기</Link>
        </p>
      </div>
    </main>
  );
